            ...
            <v-col cols="12">
                <v-card elevation="0">
                    ...
                    <v-card-text>
                        <v-row>
                            <v-col cols="4">
                                <SelectComponent v-model:itemId="agendamento.transportador_id"
            ...
            <v-col cols="12">
                <v-card elevation="0">
                    ...
                    <v-card-text>
                        <v-row>
                            <v-col cols="4">
                                <SelectComponent v-model:itemId="agendamento.veiculo_id" controller_name="veiculo"
                                    label="Veiculo"></SelectComponent>
                            </v-col>
                            <v-col cols="4">
            ...
            <v-col cols="12">
                <v-card elevation="0">
                    ...
                    <v-card-text>
                        <v-row>
                            <v-col cols="4">
                                <SelectComponent v-model:itemId="agendamento.motorista_id" controller_name="motorista"
                                    label="Motorista"></SelectComponent>
                            </v-col>
                            <v-col cols="4">
