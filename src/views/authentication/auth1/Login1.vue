                  ...
                  <v-card-text class="pa-9">
                    ...
                    <v-row>
                      <v-col cols="12" class="text-center">
                        <img src="../../../assets/images/logos/inflow_full.png" width="140" />
                        <h2 class="text-secondary text-h2 mt-8">Seja bem-vindo</h2>
                        <h4 class="text-disabled text-h4 mt-3">Credencias de acesso</h4>
                      </v-col>
                    </v-row>
                    <!---Left Part Logo -->
