...
async function saveProduto() {
    //console.log('Produto:', produtoNew.value);
...
function removerPermissao(item: MenuPermissao) {
    ...
    menuNew.value.permissoes = menuNew.value.permissoes.filter(permissao => permissao !== item);
}
    ...
    <v-card>
        ...
        <v-card-text v-else class="scrollable-content">
            <v-form>
                <v-row>
                    <v-col cols="12">
                        <v-text-field density="compact" class="text-uppercase" v-model="menuNew.id" label="Id" disabled
                            variant="outlined"></v-text-field>
                    </v-col>

                    <v-col cols="12">
                        <v-text-field density="compact" class="text-uppercase" v-model="menuNew.nome" label="Nome"
                            variant="outlined"></v-text-field>
                    </v-col>
                    ...
                    <v-col cols="12" v-if="!isRoot">
                        <!--  <v-text-field density="compact" class="text-uppercase" v-model="menuNew.menu_pai"
                            label="Menu Pai" variant="outlined"></v-text-field> -->
                        <v-select label="Pasta" density="compact" variant="outlined" v-model="menuNew.menu_pai"
                            :items="menuList" item-title="label" item-value="id">

                        </v-select>
                    </v-col>

                    <v-col cols="12">
                        <v-text-field density="compact" class="text-uppercase" v-model="menuNew.icon" label="Ícone"
                            variant="outlined"></v-text-field>
                    </v-col>

                    <v-col cols="12">
                        <v-text-field density="compact" class="text-uppercase" v-model="menuNew.path_url"
                            label="URL do Caminho" variant="outlined"></v-text-field>
                    </v-col>

                    <v-col cols="12">
                        <v-text-field density="compact" class="text-uppercase" v-model="menuNew.label" label="Rótulo"
                            variant="outlined"></v-text-field>
                    </v-col>

                    <v-col cols="12">
                        <v-text-field density="compact" class="text-uppercase" v-model="menuNew.ordem" label="Ordem"
                            variant="outlined"></v-text-field>
                    </v-col>
                    ...
                    <v-col cols="12">
                        <v-text-field density="compact" class="text-uppercase" v-model="menuNew.created_at"
                            label="Criado em" variant="outlined" disabled></v-text-field>
                    </v-col>

                    <v-col cols="12">
                        <v-text-field density="compact" class="text-uppercase" v-model="menuNew.updated_at"
                            label="Atualizado em" variant="outlined" disabled></v-text-field>
                    </v-col>
                </v-row>
            </v-form>
        </v-card-text>
